...
/**
 * Estamos tornando esta classe acessível para toda a aplicação angular.
 * Isso é injeção de dependência. Esse objeto estará acessível em qualquer lugar.
 * É possível escopar a injenção de depência para módulos.
 * Classes de serviço não devem alterar variáveis.
 * Classes de serviço devem chamar/dar resultado de outras operações.
 */
